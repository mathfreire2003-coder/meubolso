...
function Dashboard({ installments, fixedExpenses, goals, settings, totalFixed, totalInst, totalGoalsMonth, balance, transactions }) {
  ...
  // Card map: ALL installments (including reimbursable) since the card bill still needs to be paid
  const cardMap = {};
  ...
  const catDetailItems = selectedCat ? [
    ...fixedExpenses.filter(e => e.active && (e.category || "Outros") === selectedCat).map(e => ({ name: e.name, amount: e.amount, type:"Fixa", sub: `Vence dia ${e.dueDay || "—"}` })),
    ...
    <div style={{ display:"flex", flexDirection:"column", gap: 18 }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap: 14 }}>
        ...
        <div className="card" style={{ padding:"16px 18px" }}>
          ...
          <p style={{ fontSize: 11, color:"#94A3B8", marginBottom: 14 }}>todos os parcelamentos incluídos</p>
          {cardData.length === 0
